...
Android 可用 target 为 `aarch64`、`armv7`、`x86_64`、`i686`，分别生成 `arm64-v8a`、`armeabi-v7a`、`x86_64`、`x86` APK。Node 版本见 `.nvmrc`；Android 还需要 SDK 36、NDK `29.0.14206865`、JDK 17 与对应 Rustup target。
