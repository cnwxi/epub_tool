...
class ImageTransfer:
    def __init__(self, epub_path, output_path):
        ...
        self.file_write_path=os.path.join(self.output_path, os.path.basename(self.epub_path).replace('.epub','_transfer.epub'))
        ...
        for img_path in self.images:
            ...
            try:
                ...
                if image.mode in ('RGBA', 'LA') or (image.mode == 'P' and 'transparency' in image.info):
                    ...
                    # 写入新epub
                self.target_epub.writestr(img_path, buffer.getvalue(),zipfile.ZIP_DEFLATED)
