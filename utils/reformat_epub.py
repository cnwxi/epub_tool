...
class EpubTool:
    ...
    def create_tgt_epub(self):
        ...
        return zipfile.ZipFile(path.join(output_path , self.epub_name.replace('.epub','_reformat.epub')), 'w',
                               zipfile.ZIP_STORED)
    ...
    def restructure(self):
        ...
        #OEBPS
        re_path_map = {'text':{},'css':{},'image':{},'font':{},'audio':{},'video':{},'other':{}} # { ori_bkpath : re_basename }
