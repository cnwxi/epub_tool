...
BASE_REQUIRED_MODULES = [
    ...
    "chardet",
    "bidi",
    "python_backend.services.epub.reformat_epub",
    "python_backend.services.epub.decrypt_epub",
    "python_backend.services.epub.encrypt_epub",
    "python_backend.services.font.encrypt_font",
    "python_backend.services.font.decrypt_font",
    "python_backend.services.image.webp_to_img",
    "python_backend.services.image.image_compress",
    "python_backend.services.image.image_to_webp",
    "python_backend.services.text.chinese_convert",
    "python_backend.services.image.replace_cover",
    "opencc",
]
